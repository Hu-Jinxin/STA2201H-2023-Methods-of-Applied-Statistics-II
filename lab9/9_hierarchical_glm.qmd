...
mod1<-stan(data=stan_data,file="D:\\lab9\\lab9_1.stan")
...
```{r}
mod2<-stan(data=stan_data,file="D:\\lab9\\lab9_2.stan")
```
...
```{r}
mod3<-stan(data=stan_data,file="D:\\lab9\\lab9_3.stan")
```
...
res_mod |>
  ...
  ggplot(aes(log_smr,median_mod1,color="Model 1"),alpha=0.6)+
